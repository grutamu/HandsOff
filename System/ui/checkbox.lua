...
function createCheckBox(parent,value,x,y,checkState)
	...
	if _G[parent..name.."Check"] == nil then
		if HandsOff_data.options[GetSpecialization()] then
			if HandsOff_data.options[GetSpecialization()][name.."Check"] == nil then
				if value.base == 1 then
					HandsOff_data.options[GetSpecialization()][name.."Check"] = 1
				end
			end
		end
		...
		_G[parent..name.."Check"]:SetAlpha(HandsOff_data.HandsOffUI.alpha)
		...
		if HandsOff_data.options[GetSpecialization()] and HandsOff_data.options[GetSpecialization()][name.."Check"] == 1 then
		...
		-- varDir = HandsOff_data.HandsOffUI.optionsFrames.options.enemiesEngine
		_G[parent..name.."Check"]:SetScript("OnClick", function()
			if HandsOff_data.options[GetSpecialization()][name.."Check"] == 1 then
				HandsOff_data.options[GetSpecialization()][name.."Check"] = 0
