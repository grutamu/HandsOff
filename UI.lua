...
function BadBoyFrame()
	...
	local anchor,x,y
	if not BadBoy_data.HandsOffUI.mainButton then
		anchor = "CENTER"
		x = -75
		y = -200
	else
		anchor = BadBoy_data.HandsOffUI.mainButton.pos.anchor or "CENTER"
		x = BadBoy_data.HandsOffUI.mainButton.pos.x or -75
		y = BadBoy_data.HandsOffUI.mainButton.pos.y or -200
	end
	...
	mainButton:SetScript("OnReceiveDrag", function(self)
		...
		BadBoy_data.HandsOffUI.mainButton.pos.x = x
		BadBoy_data.HandsOffUI.mainButton.pos.y = y
		BadBoy_data.HandsOffUI.mainButton.pos.anchor = anchor
	end)
	...
	mainText:SetFont(BadBoy_data.HandsOffUI.font,BadBoy_data.HandsOffUI.fontsize,"THICKOUTLINE")
	mainText:SetTextHeight(BadBoy_data["buttonSize"]/3)
	...
	function CreateButton(Name,x,y)
		...
		_G["text"..Name]:SetFont(BadBoy_data.HandsOffUI.font,BadBoy_data.HandsOffUI.fontsize,"THICKOUTLINE")
