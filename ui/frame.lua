...
function frameCreation(name,width,heigth,title)
	if _G[name.."Frame"] == nil then
		...
		if HandsOff_data.HandsOffUI[name.."Frame"] == nil then
			HandsOff_data.HandsOffUI[name.."Frame"] = {
				color = {
					r = 16,
					g = 16,
					b = 16,
		...
		if HandsOff_data.HandsOffUI[name.."Frame"] ~= nil and HandsOff_data.HandsOffUI[name.."Frame"].pos ~= nil then
			anchor = HandsOff_data.HandsOffUI[name.."Frame"].pos.anchor or "CENTER"
			x = HandsOff_data.HandsOffUI[name.."Frame"].pos.x or -75
			y = HandsOff_data.HandsOffUI[name.."Frame"].pos.y or -200
		else
			anchor = "CENTER"
			x = 75
			y = 200
		...
		_G[name.."Frame"].texture:SetTexture(HandsOff_data.HandsOffUI[name.."Frame"].color.r/255,HandsOff_data.HandsOffUI[name.."Frame"].color.g/255,HandsOff_data.HandsOffUI[name.."Frame"].color.b/255,HandsOff_data.HandsOffUI[name.."Frame"].color.a)
		...
		_G[name.."FrameTitle"]:SetFont(HandsOff_data.HandsOffUI.font,HandsOff_data.HandsOffUI.fontsize+1,"THICKOUTLINE")
		...
		if HandsOff_data.options[GetSpecialization()] and HandsOff_data.options[GetSpecialization()][name.."Frame"] == false then
			_G[name.."Frame"]:Hide()
		end
		...
		_G[name.."Frame"]:SetScript("OnReceiveDrag", function(self)
			...
			HandsOff_data.HandsOffUI[name.."Frame"].pos.x = x
			HandsOff_data.HandsOffUI[name.."Frame"].pos.y = y
			HandsOff_data.HandsOffUI[name.."Frame"].pos.anchor = anchor
		end)
