...
function createStatusBar(parent,option,x,y)
	...
	if  HandsOff_data.options[GetSpecialization()] then
		currentValue = HandsOff_data.options[GetSpecialization()][value.."Status"]
	end
	...
	if _G[parent..value.."Status"] == nil then
		...
		_G[parent..value.."Status"]:SetAlpha(HandsOff_data.HandsOffUI.alpha)
		-- status part
		...
		if enabled then
			...
			_G[parent..value.."Status"]:SetScript("OnMouseWheel", function(self, delta)
				...
				HandsOff_data.options[GetSpecialization()][value.."Status"] = currentValue or 0
		...
		_G[parent..value.."StatusText"]:SetAlpha(HandsOff_data.HandsOffUI.alpha)
		_G[parent..value.."StatusText"]:SetJustifyH("CENTER")
		_G[parent..value.."StatusText"]:SetFont(HandsOff_data.HandsOffUI.font,HandsOff_data.HandsOffUI.fontsize,"THICKOUTLINE")
...
function createNovaStatusBar(parent,option,x,y,width,heigth)
	...
	if _G[parent..value.."Nova"] == nil then
		...
		_G[parent..value.."Nova"]:SetAlpha(HandsOff_data.HandsOffUI.alpha)
		-- status part
		...
		_G[parent..value.."NovaText"]:SetAlpha(HandsOff_data.HandsOffUI.alpha)
		_G[parent..value.."NovaText"]:SetJustifyH("CENTER")
		_G[parent..value.."NovaText"]:SetFont(HandsOff_data.HandsOffUI.font,HandsOff_data.HandsOffUI.fontsize,"THICKOUTLINE")
