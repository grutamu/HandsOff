...
function createTextString(parent,value,x,y,heigth,width)
	...
	_G[parent..value.."TextFrame"]:SetAlpha(HandsOff_data.HandsOffUI.alpha)
...
function createTitleString(parent,value,x,y)
	...
	_G[parent..value.."TitleFrame"]:SetAlpha(HandsOff_data.HandsOffUI.alpha)
	--_G[parent..value.."TextFrame"]:Hide()
	...
	_G[parent..value.."Text"]:SetPoint("TOPLEFT",0,0)
	_G[parent..value.."Text"]:SetAlpha(HandsOff_data.HandsOffUI.alpha)
	_G[parent..value.."Text"]:SetFont(HandsOff_data.HandsOffUI.font,(HandsOff_data.HandsOffUI.fontsize+2)*scale,"THICKOUTLINE")
